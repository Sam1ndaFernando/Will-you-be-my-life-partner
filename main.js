...
function getRandomNumber(min, max) {
    // Calculate the random number between min and max
...
btnYes.addEventListener("click", (e) => {
    ...
    // Add the text "Hureee Huree" to the container
    const hureeeText = document.createElement("p");
    hureeeText.textContent = "Yhe Yhe Huree Huree!! My Crush said yessss !!!";
